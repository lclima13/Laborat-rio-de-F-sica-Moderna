...
plt.title('Espectroscopia LedTubo Red Tide USB 650')
plt.grid()
plt.show()
...
plt.title('Histograma dos Dados LedTubo')
plt.grid()
# Mostrar o gráfico
plt.show()
...
plt.xlim(-1,1)
plt.legend()
plt.title('Distribuição Gaussiana LedTubo')
plt.grid()
plt.show()
...
plt.ylabel('Intensidade')
plt.xlabel('$\lambda$(nm)')
plt.title('Gráfico Sinal/Ruido LedTubo para 1$\sigma$(68%)')
...
plt.ylabel('Intensidade')
plt.xlabel('$\lambda$(nm)')
plt.title('Gráfico Sinal/Ruido LedTubo para 2$\sigma$(95%)')
...
plt.ylabel('Intensidade')
plt.xlabel('$\lambda$(nm)')
plt.title('Gráfico Sinal/Ruido LedTubo para 3$\sigma$(99,7%)')
...
caminho_arquivo = 'dados_estatisticos_LedTubo.txt'
